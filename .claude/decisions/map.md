...
| [0025](0025-a-row-opens-its-record-and-does-nothing-else.md) | a list row is given an action, or a row's click target is in question | accepted | `src/lib/design/block/list.svelte`, `src/lib/dashboard/component/section.svelte` |
...
| [0034](0034-a-record-card-carries-its-actions-twice.md) | a record card or list row is given an action | accepted | `src/lib/design/block/record-card.svelte`, `src/lib/design/block/list.svelte` |
