...
never built. Both are consumed by [ADR 0019](../decisions/0019-the-work-queue-is-the-landing-screen.md);
...
- **No schema change.** Every figure needed is already stored: the payment aggregates are
  materialized columns ([ADR 0006](../decisions/0006-payment-aggregates-are-materialized.md)),
...
- **[ADR 0013](../decisions/0013-list-presentation-is-per-concept.md)'s seam holds**, and is
...
- **Both surfaces must move.** Nothing this repository writes for itself currently animates —
  ...
  [ADR 0016](../decisions/0016-motion-responds-and-uses-what-is-installed.md) and the frontend
...
[ADR 0020](../decisions/0020-surfaces-diverge-by-kind-not-by-operation.md), and the direction is
