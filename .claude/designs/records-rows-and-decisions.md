...
sources:
  ...
  - src/lib/tenant/component/directory.svelte
  - src/lib/complex/component/details.svelte
  - src/lib/complex/component/directory.svelte
  - src/lib/complex/component/unit-details.svelte
  - src/lib/complex/component/unit-count.svelte
  ...
  - src/lib/layout/component/startup-workspace-choice.svelte
  - src/lib/sync/component/conflict-panel.svelte
  - .claude/evidence/prototypes/directory-row-colour.md
---
...
- **A list narrows in SQL** ([ADR 0010](../decisions/0010-a-list-narrows-in-sql.md)), so
...
([directory-row-colour](../evidence/prototypes/directory-row-colour.md)). Three variants ran on
