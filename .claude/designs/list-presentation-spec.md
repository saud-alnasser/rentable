...
the presentation half, on [ADR 0013](../decisions/0013-list-presentation-is-per-concept.md)
and decision 07 of [`ui-overhaul.md`](ui-overhaul.md).
...
- **[ADR 0010](../decisions/0010-lists-load-whole-result-sets.md) holds unchanged.** One
