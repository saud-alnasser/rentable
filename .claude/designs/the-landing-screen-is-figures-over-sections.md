...
sources:
  ...
  - .claude/evidence/prototypes/the-landing-screen-shape.md
...
shape was never decided — [the discussion that parked it](../evidence/discussions/the-dashboard-after-the-queues-action.md)
...
[the prototype](../evidence/prototypes/the-landing-screen-shape.md), at the running window,
...
[recorded here](../evidence/prototypes/status-glyphs-and-the-payment-ring.md) — and that ring
...
- **IPC payload is the durable cost.** [The performance baseline](../evidence/research/interface-performance-baseline.md)
...
- **The landing screen is figures over sections, and a figure routes or a section holds rows.**
  This contradicts [ADR 0014](../decisions/0014-the-dashboard-is-the-days-work.md)'s positive
