...
| [list-presentation-spec](list-presentation-spec.md) | accepted | `src/lib/design/block/`, `src/lib/design/cell/`, `src/lib/contract/`, `src/lib/payment/`, `src/lib/tenant/`, `src/lib/complex/` |
