...
| [the-landing-screen-is-figures-over-sections](the-landing-screen-is-figures-over-sections.md) | accepted | `src/lib/dashboard/dashboard.ts`, `src/lib/dashboard/router.ts`, `src/lib/dashboard/component/queue.svelte`, `src/lib/contract/router.ts`, `src/lib/contract/component/directory.svelte`, `src/lib/design/cell/fulfillment.svelte`, `.claude/evidence/prototypes/the-landing-screen-shape.md`, `.claude/evidence/discussions/the-dashboard-after-the-queues-action.md` |
