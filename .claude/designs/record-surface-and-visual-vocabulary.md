...
status: implemented
sources:
  - src/lib/tenant/component/details.svelte
  - src/lib/contract/component/details.svelte
  - src/lib/payment/component/details.svelte
  - src/lib/complex/component/details.svelte
  - src/lib/complex/component/unit-details.svelte
  - src/lib/design/block/list.svelte
  - src/lib/design/block/standalone-surface.svelte
  - src/lib/design/block/record-actions.svelte
  - src/lib/design/block/back-control.svelte
  - src/app.css
  - src/routes/
---
...
- **Reading surfaces take their concept's shape.** A read surface is the concept's own to
  present ([ADR 0020](../decisions/0020-surfaces-diverge-by-kind-not-by-operation.md)). The
...
[ADR 0032](../decisions/0032-a-record-surface-is-one-shell-with-a-per-concept-body.md)
...
([the-record-surface-treatment](../evidence/prototypes/the-record-surface-treatment.md));
...
available either: [ADR 0010](../decisions/0010-lists-load-whole-result-sets.md) loads whole
...
[ADR 0013](../decisions/0013-list-presentation-is-per-concept.md) named when it rejected
