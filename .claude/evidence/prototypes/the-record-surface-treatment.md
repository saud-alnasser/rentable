...
owner: repository
kind: prototypes
falsifies: [.claude/designs/record-surface-and-visual-vocabulary.md]
---
...
Consumed: `.claude/designs/record-surface-and-visual-vocabulary.md`, "Architecture" — the
...
- The switcher's own placement forced the throwaway route: **Vite refuses to serve a component
  from `.claude/position/prototypes/`**, which is where `.claude/policies/evidence.md` says
