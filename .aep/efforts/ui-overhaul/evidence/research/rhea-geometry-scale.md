...
Taken for [#220](https://github.com/saud-alnasser/rentable/issues/220). ADR 0007 settled that Rhea is transcribed by hand; this is the transcription.
...
- ADR 0007 claims Rhea "adjusts component geometry and density directly, in the component class strings, rather than by multiplying variables". **Confirmed** — the absence of any theme item is the positive evidence.
