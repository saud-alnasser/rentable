...
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/18-a-signed-row-never-reaches-wider-than-its-certificate]] fix(organization): a signed row never reaches wider than its certificate | 838-permissions-are-a-role-and-an-override | open | — |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/19-the-roles-block-and-the-tests-follow-the-rules]] fix(desktop): the roles block and its tests follow the rules | 838-permissions-are-a-role-and-an-override | open | — |
