...
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/08-the-units-tab-shows-every-held-unit]] fix(contract): the units tab shows every unit the contract holds | 832-the-interface-speaks-one-language-and-guides | open | — |
