...
| 838-permissions-are-a-role-and-an-override | implemented | [[efforts/838-permissions-are-a-role-and-an-override/spec]] | 0 | 0 | 21 |
...
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/04-named-shape-and-elevation]] feat(design): named shape and elevation | 832-the-interface-speaks-one-language-and-guides | resolved | 01 |
...
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/09-contract-acts-are-declared-once]] refactor(contract): a contract's acts are declared once, and one host runs them | 832-the-interface-speaks-one-language-and-guides | resolved | 03 |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/10-the-other-concepts-acts]] refactor(desktop): tenant, complex, unit and payment acts are declared once | 832-the-interface-speaks-one-language-and-guides | resolved | 09 |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/11-member-and-workspace-acts]] refactor(organization): member and workspace acts are declared once | 832-the-interface-speaks-one-language-and-guides | resolved | 09 |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/12-one-create-control-and-key]] feat(desktop): one create control, one create key | 832-the-interface-speaks-one-language-and-guides | resolved | 10 |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/13-delete-offers-undo]] feat(desktop): an ordinary delete offers undo, and a confirmation names its act | 832-the-interface-speaks-one-language-and-guides | resolved | 10, 11 |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/14-one-search-and-the-palette-everywhere]] feat(desktop): one search, and the command menu on every screen | 832-the-interface-speaks-one-language-and-guides | resolved | 11 |
...
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/16-empty-states-lead]] feat(desktop): empty states say what comes next | 832-the-interface-speaks-one-language-and-guides | resolved | 12 |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/17-navigation-holds]] feat(desktop): navigation holds | 832-the-interface-speaks-one-language-and-guides | resolved | 10 |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/18-forms-take-one-weight-and-the-right-control]] feat(desktop): forms take one weight per concept, and each field its control | 832-the-interface-speaks-one-language-and-guides | resolved | 10 |
...
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/27-the-walk]] test(desktop): every route walked in both directions and both appearances | 832-the-interface-speaks-one-language-and-guides | resolved | 02, 04, 06, 07, 14, 15, 16, 26, 28, 29, 30, 31, 32 |
...
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/34-members-and-workspaces-in-the-command-menu]] feat(organization): the command menu reaches member and workspace acts | 832-the-interface-speaks-one-language-and-guides | resolved | — |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/35-every-failure-reads-in-the-readers-language]] fix(api): every failure reads in the reader's language | 832-the-interface-speaks-one-language-and-guides | resolved | — |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/36-every-trail-runs-through-its-parent]] fix(desktop): every record's trail runs through its parent, and the context says what is there | 832-the-interface-speaks-one-language-and-guides | resolved | — |
| [[efforts/832-the-interface-speaks-one-language-and-guides/tickets/37-the-machines-words-stay-behind-details]] fix(desktop): the shell's own words stay behind details | 832-the-interface-speaks-one-language-and-guides | resolved | — |
...
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/01-one-vocabulary-of-flags-and-roles]] feat(organization): one vocabulary of flags, roles and the effective computation | 838-permissions-are-a-role-and-an-override | resolved | — |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/02-an-old-organization-is-refused-by-name]] feat(organization): an organization carries a format, and one from another version is refused by name | 838-permissions-are-a-role-and-an-override | resolved | — |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/03-certificates-are-delegated]] feat(organization): certificates are delegated and carry a ceiling and a rank | 838-permissions-are-a-role-and-an-override | resolved | 01, 02 |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/04-members-and-roles-are-rows-the-chain-signs]] feat(organization): members and roles are rows the chain signs | 838-permissions-are-a-role-and-an-override | resolved | 03 |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/05-invitation-reset-and-removal-run-on-the-chain]] refactor(organization): invitation, reset and removal run on the delegated chain | 838-permissions-are-a-role-and-an-override | resolved | 04 |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/06-grants-workspaces-mark-and-handover-run-on-the-chain]] refactor(organization): grants, workspaces, the mark and the handover run on the delegated chain | 838-permissions-are-a-role-and-an-override | resolved | 04 |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/07-a-manager-shapes-roles-below-their-rank]] feat(organization): a manager shapes roles and assigns them below their rank | 838-permissions-are-a-role-and-an-override | resolved | 05, 06 |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/08-effective-permissions-cross-the-boundary]] feat(desktop): effective permissions and roles cross the boundary | 838-permissions-are-a-role-and-an-override | resolved | 07 |
...
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/13-a-kind-not-viewable-is-absent-from-every-other-kinds-results]] feat(desktop): a record kind the member cannot view is absent from every other kind's results | 838-permissions-are-a-role-and-an-override | resolved | — |
...
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/20-two-machines-acting-together-never-brick-the-directory]] fix(organization): two machines acting together never brick the directory | 838-permissions-are-a-role-and-an-override | resolved | — |
| [[efforts/838-permissions-are-a-role-and-an-override/tickets/21-the-unused-workspace-gate-is-deleted]] refactor(desktop): the unused workspace gate is deleted | 838-permissions-are-a-role-and-an-override | resolved | — |
