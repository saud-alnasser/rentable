<script lang="ts">
	 ...
	 *
	 * **The words that differ between the callers are props, and the shape is not.** What the link
	 * is called and the notice above it are the host's; everything below the notice is the same
	 * block wherever it is drawn.
	 *
