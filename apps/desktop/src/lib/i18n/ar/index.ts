...
const ar = {
	...
	organization: {
		setup: {
			...
			nameTitle: 'سمِّها',
			nameDescription:
				'اسم المؤسسة، واسم المستخدم الخاص بك، وكلمة المرور التي تفتح مكانك فيها. لا يُكتب شيء آخر هنا.',
		...
		dashboard: {
			...
			invite: 'ادعُ',
			cannotSend:
				'rentable لا يرسل شيئًا. انسخ الرابط واسم المستخدم وكلمة المرور أدناه وسلمها للشخص بنفسك؛ كلمة المرور تظهر مرة واحدة.',
			...
			usernameCopied: 'نُسخ اسم المستخدم.',
			done: 'تم',
