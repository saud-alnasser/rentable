...
const ar = {
	...
	layout: {
		...
		signIn: {
			...
			organizationDescription:
				'كلمة مرورك تسجّل دخولك إلى المؤسسة، على هذا الجهاز، مع اتصال أو من دونه.',
	...
	organization: {
		setup: {
			...
			nameDescription:
				'اختر اسماً للمؤسسة، واسم المستخدم الخاص بك، وكلمة مرور، واذكر مجموعة Turso التي حدّدتها. كلمة المرور تفتح مكانك فيها.',
			...
			groupDescription:
				'المجموعة التي حدّدتها في شاشة موافقة Turso. قاعدة بيانات المؤسسة تسكن فيها.',
		...
		join: {
			...
			codeDescription:
				'الأحرف الستة التي أملاها عليك من دعاك. تنتهي صلاحيته بعد تسعين ثانية من إنشائه؛ اطلب منه رمزًا جديدًا إن انتهت.',
		...
		dashboard: {
			...
			codeExpires: 'تنتهي صلاحيته خلال {seconds} ثانية',
			codeLapsed: 'انتهت صلاحية هذا الرمز.',
			freshCode: 'رمز جديد',
			memberCode: 'أنشئ رمز تأكيد',
			done: 'تم',
			...
			linkDescription:
				'يربط الرابط جهازًا آخر بهذه المؤسسة؛ ومع اسم مستخدم وكلمة مرور يكون هو الطريق إلى الداخل. يحمل عرضًا للدليل بالقراءة فقط، فشاركه كما تشارك كلمة مرور.',
