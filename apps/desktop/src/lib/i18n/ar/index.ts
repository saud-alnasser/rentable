...
const ar = {
	...
	layout: {
		...
		signIn: {
			...
			noOrganizationSubtitle:
				'تُنشأ المؤسسة على حساب Turso الخاص بك، أو تنضم إليها عبر رابط استلمته.',
	...
	settings: {
		...
		you: {
			...
			anotherMachine: {
				title: 'جهاز آخر',
				description:
					'اربط جهازًا آخر يخصّك. ستحصل على رابط ورمز؛ افتح الرابط على ذلك الجهاز، واكتب الرمز، ثم سجّل الدخول هناك بنفس اسم المستخدم وكلمة المرور. لا يتغيّر شيء في هذا الجهاز.',
				action: 'اربط جهازًا آخر',
				linkTitle: 'رابط الجهاز الآخر',
				notice:
					'rentable لا يرسل شيئًا، وهذا الزوج يُعرض مرة واحدة. افتح الرابط على الجهاز الذي تربطه واكتب الرمز هناك؛ يقبل جهازًا واحدًا مرة واحدة، وإن فقدته فاصنع غيره من هنا.'
			},
			sessions: {
	...
	organization: {
		...
		join: {
			title: 'الربط بمؤسسة',
			description:
				'الصق الرابط الذي سُلّم إليك، وليكن الرمز المرافق له في متناولك. رابط الدعوة يطلب الرمز وكلمة مرور تختارها، والرابط الذي أنشأته لهذا الجهاز يطلب الرمز وحده، ورابط المؤسسة ينقلك مباشرة إلى تسجيل الدخول.',
			linkLabel: 'الرابط الذي سُلّم إليك',
			...
			replaced:
				'حلّ رابط أحدث محل هذا الرابط. أنشئ رابطًا آخر من قسم «أنت» على جهاز سجّلت دخولك عليه من قبل.',
			...
			codeDescription:
				'الأحرف الستة التي أملاها عليك من دعاك. إنه النصف الآخر مما يحتاجه الرابط، ويبقى صالحًا ما بقي الرابط.',
			codeWrong: 'الرمز خاطئ. اطلب ممن أرسل إليك الرابط أن يمليه عليك مجددًا.',
			codeMissing: 'اكتب الأحرف الستة التي رافقت الرابط.',
			machineTitle: 'اربط هذا الجهاز',
			machineDescription:
				'هذا رابط أنشأته لهذا الجهاز. اكتب الرمز المرافق له، ثم سجّل الدخول باسم المستخدم وكلمة المرور اللذين تستعملهما أصلًا.',
		...
		dashboard: {
			...
			inviteDescription:
				'الدعوة تجعل الشخص عضوًا: اسم المستخدم والدور ومساحات العمل التي يحملها، كلٌّ منها بوصول كامل أو قراءة فقط. أنت من يسلّمه الرابط بنفسك.',
			role: 'الدور',
			...
			linkDescription:
				'احتفظ بهذا في مكان خاص: إنه النسخة التي تستعيد بها المؤسسة حين لا يبقى أي جهاز. فتحه على جهاز جديد يربط ذلك الجهاز، واسم مستخدم وكلمة مرور يسجّلان دخولك. لا تنتهي صلاحيته ويحمل عرضًا للدليل بالقراءة فقط، فليس هو الرابط الذي يُوزَّع. ولربط جهاز آخر يخصّك، اصنع له رابطًا من قسم «أنت» في إعداداتك.',
	...
	workspace: {
		...
		syncStatusAccountRefused: 'حساب Turso يحتاج إلى عناية',
