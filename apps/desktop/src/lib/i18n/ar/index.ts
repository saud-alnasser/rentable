...
const ar = {
	...
	organization: {
		...
		join: {
			title: 'الربط بمؤسسة',
			description:
				'الصق رابط المؤسسة. يسجّل هذا الجهاز المؤسسة، ثم تسجّل الدخول إليها باسم المستخدم وكلمة المرور.',
			linkLabel: 'رابط المؤسسة',
			reading: 'يجري الربط بالمؤسسة...',
			unreadable: 'هذا ليس رابط مؤسسة من rentable. الصق الرابط كاملاً كما سُلّم إليك تمامًا.',
