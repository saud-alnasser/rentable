...
const ar = {
	...
	organization: {
		...
		dashboard: {
			...
			inviteDescription:
				'الدعوة تصنع حسابهم في المؤسسة: اسم المستخدم والدور ومساحات العمل التي يحملونها، كلٌّ منها بوصول كامل أو قراءة فقط. أنت من يسلمهم الرابط بنفسك.',
			role: 'الدور',
			...
			codeDescription:
				'أملِ هذا الرمز في مكالمة أو وجهًا لوجه. إنه النصف الآخر مما يفتح مكانه، فلا يُرسل أبدًا مع الرابط.',
