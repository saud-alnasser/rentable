...
const ar = {
	...
	organization: {
		setup: {
			...
			connectGroup:
				'في لوحة تحكم Turso، أنشئ مجموعة فارغة لـ rentable ثم اخترها في شاشة الموافقة. تشمل الموافقة تلك المجموعة وحدها.',
			connectAccount: 'لا حساب Turso بعد؟ يمكنك إنشاء واحد من شاشة الموافقة.',
			connectSuccession:
				'تعيش المؤسسة في تلك المجموعة. في الحساب الشخصي أنت وحدك من يمنح الصلاحية مجدداً؛ وفي منظمة Turso يستطيع أي مدير ذلك، وتستطيع Turso نقل المجموعة إليها. لا يفعل rentable أياً منهما نيابة عنك.',
