...
const ar = {
	...
	layout: {
		...
		noWorkspace: {
			...
			creating: 'يجري إنشاء مساحة العمل على حساب Turso الخاص بك وإعطاؤها شكلها. يستغرق هذا لحظة.',
			created: 'تم إنشاء مساحة العمل.',
			ownerOnly:
				'المالك هو من ينشئ مساحة العمل الأولى، من الجهاز الذي ربط حساب Turso. اسأل المالك.',
	...
	organization: {
		setup: {
			...
			connectTitle: 'اربط حساب Turso',
			connectDescription: 'موافقة واحدة في المتصفح، ولا يُلصق أو يُكتب شيء هنا.',
			groupPreparation:
				'أولاً، أنشئ في لوحة تحكم Turso مجموعة فارغة لـ rentable واخترها في شاشة الموافقة. تمنح الموافقة rentable صلاحية على تلك المجموعة وحدها، فالمجموعة الفارغة تُبقي هذه الصلاحية محصورة في قواعد البيانات التي ينشئها rentable.',
			accountCreation: 'لا حساب Turso بعد؟ شاشة الموافقة هي حيث تنشئ واحداً.',
			succession:
				'ستعيش المؤسسة في منظمة Turso التي تحمل المجموعة التي تختارها. إن كانت حساباً شخصياً، فأنت وحدك من يستطيع منح rentable الصلاحية عليه مجدداً. يستطيع مدير ثانٍ في منظمة Turso فعل الشيء نفسه، وتستطيع Turso نقل مجموعة إلى منظمة أخرى من لوحة تحكمها. لا يفعل rentable أياً منهما نيابة عنك.',
			...
			nameTitle: 'سمِّها',
			nameDescription: 'اسم المؤسسة، وكلمة المرور التي تفتح مكانك فيها. لا يُكتب شيء آخر هنا.',
			nameLabel: 'اسم المؤسسة',
			nameRequired: 'أعطِ المؤسسة اسماً.',
			nameTooLong: 'هذا الاسم طويل جداً.',
			passwordLabel: 'كلمة مرورك',
			passwordFloor:
				'استخدم 12 حرفاً على الأقل. لا يوجد خادم يبطئ التخمين، فكلمة المرور هي الشيء الوحيد بين من يحمل السجلات وقراءتها.',
			passwordTooShort: 'استخدم 12 حرفاً على الأقل.',
			create: 'أنشئ المؤسسة',
			creating: 'يجري إنشاء المؤسسة على حساب Turso الخاص بك...',
			doneTitle: 'مؤسستك جاهزة',
			doneDescription:
				'سلِّم هذا الرابط لمن تدعوهم. يجد الرابط المؤسسة ولا أكثر؛ دعوة كل شخص وكلمة مروره منفصلتان.',
			linkLabel: 'رابط الانضمام',
			copyLink: 'انسخ الرابط',
			linkCopied: 'تم نسخ الرابط.',
			notYetSent:
				'المؤسسة موجودة على هذا الجهاز وستصل إلى Turso حين يعود الاتصال. يعمل الرابط بعد وصولها.',
			continue: 'متابعة',
			back: 'رجوع'
		},
		join: {
			title: 'انضم إلى مؤسسة',
			description: 'افتح الدعوة التي سُلّمت إليك: رابط، وكلمة المرور التي جاءت معه.',
			linkLabel: 'رابط الدعوة',
			open: 'افتح الرابط',
			reading: 'تجري قراءة الدعوة...',
			unreadable: 'هذا ليس رابط دعوة من rentable. الصق الرابط كاملاً كما سُلّم إليك تمامًا.',
			unreachable: 'تعذّر الوصول إلى المؤسسة. الرابط صحيح؛ حاول مجددًا حين يعود الاتصال.',
			tryAgain: 'حاول مجددًا',
			pasteAnother: 'الصق رابطًا آخر',
			found: 'هذا الرابط يجد {name}.',
			refusedLapsed:
				'انتهت صلاحية الدعوة. اطلب من الشخص الذي دعاك دعوة جديدة؛ الرابط نفسه لا تنتهي صلاحيته.',
			refusedConsumed: 'استُخدمت هذه الدعوة من قبل. سجّل الدخول بكلمة مرورك بدلاً من ذلك.',
			refusedRevoked: 'أُلغيت الدعوة. اطلب من الشخص الذي دعاك دعوة جديدة.',
			restoreDescription:
				'هذا هو رابط المؤسسة نفسها. إن كان لك مكان فيها بالفعل، فكلمة مرورك تفتحه على هذا الجهاز أيضًا.',
			emailLabel: 'بريدك الإلكتروني',
			emailOptional: 'العنوان الذي دُعيت به. المالك لم يُدعَ بعنوان ويترك هذا فارغًا.',
			restore: 'استعد مكاني',
			passwordLabel: 'كلمة المرور التي سُلّمت إليك',
			join: 'انضم',
		...
		dashboard: {
			...
			invite: 'ادعُ',
			cannotSend:
				'rentable لا يرسل شيئًا. انسخ الرابط وكلمة المرور أدناه وسلمهما للشخص بنفسك؛ كلمة المرور تظهر مرة واحدة.',
			generatedPassword: 'كلمة المرور المولّدة',
			passwordOnce: 'هذه المرة الوحيدة التي تظهر فيها كلمة المرور. يغيرونها عند أول تسجيل دخول.',
			...
			linkTitle: 'رابط المنظمة',
			linkDescription:
				'الرابط الذي يضيف هذه المنظمة على جهاز آخر، والذي تستعيدها منه إذا فُقد هذا الجهاز. يحمل عرضًا للقراءة فقط للدليل، فشاركه كما تشارك كلمة مرور.',
