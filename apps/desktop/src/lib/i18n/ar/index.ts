	...
	organization: {
		...
		dashboard: {
			...
			acceptOwnershipAuthority:
				'يبقى حساب Turso مع من وصله. وحتى تصل حسابك أنت من قسم المزامنة، يبقى إنشاء مساحة عمل وحظر أحد وتجديد الاعتمادات يجري على جهازه هو أو لا يجري.',
			acceptOwnershipPassword: 'كلمة مرورك',
