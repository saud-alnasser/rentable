...
const ar = {
	...
	organization: {
		setup: {
			...
			connectGroup:
				'أولاً، أنشئ في لوحة تحكم Turso مجموعة فارغة لـ rentable واخترها في شاشة الموافقة. تشمل الموافقة تلك المجموعة وحدها ولا شيء غيرها.',
			connectAccount: 'لا حساب Turso بعد؟ أنشئ واحداً من شاشة الموافقة.',
			connectSuccession:
				'تعيش المؤسسة حيث تعيش تلك المجموعة. في الحساب الشخصي أنت وحدك من يمنح rentable الصلاحية مجدداً؛ وفي منظمة Turso يستطيع أي مدير ذلك، وتستطيع Turso نقل المجموعة إليها من لوحة تحكمها. لا يفعل rentable أياً منهما نيابة عنك.',
			...
			workspaceTitle: 'سمِّ مساحة عملك الأولى',
			workspaceDescription:
				'تحمل مساحة العمل مجموعة واحدة من السجلات. يمكن إضافة المزيد لاحقاً من داخل التطبيق.',
