...
const ar = {
	...
	layout: {
		startup: {
			...
			recoveryDescription:
				'فشل rentable في إكمال التشغيل بعد التحديث إلى الإصدار v{version}. اختر إما استعادة النسخة الاحتياطية المحمية قبل التحديث أو إعادة محاولة التشغيل.',
			recoveryDetails:
				'تم الاكتشاف في {detectedAt}. التراجع يعيد النسخة الاحتياطية المحمية ويقفل التطبيق حتى تتمكن من إعادة تثبيت الإصدار السابق. المتابعة تقوم بمسح الاسترداد وإعادة محاولة التشغيل بالإصدار الحالي.',
