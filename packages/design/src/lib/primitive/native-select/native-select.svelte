...
>
	<select
		...
		class={cn(
			'h-9 w-full min-w-0 appearance-none rounded-md border border-input bg-input/30 px-3 py-2 pe-9 text-sm transition-[color,box-shadow] outline-none selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground hover:bg-input/50 disabled:pointer-events-none disabled:cursor-not-allowed',
