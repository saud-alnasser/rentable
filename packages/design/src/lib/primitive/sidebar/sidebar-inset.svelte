...
<main
	...
	class={cn(
		...
		'peer-data-[variant=inset]:m-2 peer-data-[variant=inset]:rounded-2xl peer-data-[variant=inset]:shadow-raised peer-data-[variant=inset]:ring-1 peer-data-[variant=inset]:ring-foreground/10',
