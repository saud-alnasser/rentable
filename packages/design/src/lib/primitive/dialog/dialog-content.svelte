...
<DialogPortal {...portalProps}>
	...
	<DialogPrimitive.Content
		...
		class={cn(
			'fixed top-[50%] left-[50%] z-50 grid max-h-[calc(100vh-2rem)] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-0 overflow-hidden rounded-3xl bg-card p-0 shadow-overlay ring-1 ring-foreground/10 sm:max-w-lg',
			motion &&
